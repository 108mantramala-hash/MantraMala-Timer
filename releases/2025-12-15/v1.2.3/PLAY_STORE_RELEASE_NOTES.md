# Play Store Release Notes - v1.2.3

## What to Enter in Play Console

### Release Name (Internal)
```
Version 1.2.3 - [Add title here]
```
...
- [ ] Upload: releases\2025-12-15\v1.2.3\app-release-v1.2.3.aab
- [ ] Add release notes above
- [ ] Review and submit for review
- [ ] Monitor status in Play Console

## Files Ready for Upload
- `releases\2025-12-15\v1.2.3\app-release-v1.2.3.aab` (Play Store bundle)
- `releases\2025-12-15\v1.2.3\app-release-v1.2.3.apk` (Testing/backup)

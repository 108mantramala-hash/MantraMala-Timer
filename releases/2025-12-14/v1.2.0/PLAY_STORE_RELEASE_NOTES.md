...
- [ ] Upload: releases\2025-12-14\v1.2.0\app-release-v1.2.0.aab
- [ ] Add release notes above
- [ ] Review and submit for review
- [ ] Monitor status in Play Console

## Files Ready for Upload
- `releases\2025-12-14\v1.2.0\app-release-v1.2.0.aab` (Play Store bundle)
- `releases\2025-12-14\v1.2.0\app-release-v1.2.0.apk` (Testing/backup)

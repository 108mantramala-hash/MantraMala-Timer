# Play Store Release Notes - v1.2.0

## What to Enter in Play Console

### Release Name (Internal)
```
Version 1.2.0 - [Add title here]
```
...
- [ ] Upload: releases\2025-12-12\v1.2.0\app-release-v1.2.0.aab
- [ ] Add release notes above
- [ ] Review and submit for review
- [ ] Monitor status in Play Console

## Files Ready for Upload
- `releases\2025-12-12\v1.2.0\app-release-v1.2.0.aab` (Play Store bundle)
- `releases\2025-12-12\v1.2.0\app-release-v1.2.0.apk` (Testing/backup)
